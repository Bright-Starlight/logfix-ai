...
- [ ] T004 创建 `specs/[###-feature-name]/flow.md`，使用 Mermaid 编写中文流程图
...
- [ ] T009 Configure error handling and logging infrastructure（日志框架、`/log` 目录、文件命名）
...
- [ ] TXXX 验证功能已集成到主应用（导入、渲染、状态连接、用户入口、实际数据使用）
